...
import com.atomikos.jaxrshibernate.service.ComplexServiceWithCallbackImpl;
import com.atomikos.jaxrshibernate.service.TestService1Impl;
...
public class JerseyConfig extends ResourceConfig {
	...
	public JerseyConfig() {
		...
		register(ComplexServiceWithCallbackImpl.class);
		register(TestService1Impl.class);
	}
}